 ...
 */
function SuperButton({icon, active, children, ...props}) {
  const classes = classNames('btn flex space-x-3 transition-colors border-none', props.className, {
    'btn-primary text-white hover:shadow-sm': active
  })
