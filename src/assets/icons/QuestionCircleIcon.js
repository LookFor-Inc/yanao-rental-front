...
/**
 * Иконка вопроса с заливкой
 * @param {object} props Дополнительные свойства
 * @returns {JSX.Element} Иконка вопроса
 */
  ...
  return (
    <svg {...props} viewBox='0 0 512 512' fill='currentColor' xmlns='http://www.w3.org/2000/svg'>
      <path
        ...
        3.008 16.665-2.122 17.864-22.658 30.113-35.797 57.303-35.797 20.429 0 45.698 13.148 45.698 32.958 0
